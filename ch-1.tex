...
\begin{itemize}
 ...
 \item Appendix A: Programming Interface for MPI and OpenMP
...
%
The initial executing node set (or the {\it \Term{entire node set}}) at the
...
Fortran is Fortran 90 or later, and that of XcalableMP C is C90 or
later.
