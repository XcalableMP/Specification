...
The leading dimension is the number of elements to increment one element of the specified dimension.
For example, if a[10][20][30] is defined in XcalableMP C, 
the leading dimension in the first dimension is 600, that of the second dimension is 30, and
that of the last dimension is 1.
