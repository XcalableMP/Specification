...
be zero. As a result, {\tt b} is an array of 25 elements
({\tt b(0:24)}) on {\tt n(2)}. The table below shows the correspondence
...
The {\tt \Directive{async}} construct ...
...
It is assumed that the code of the left is executed by node {\tt p(1)}
while that on  the right is executed by node {\tt p(2)}.
