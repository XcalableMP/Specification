...
\begin{tabular}{ll}
\verb![C]! & {\it array-name}{\tt [} {\it triplet} $\vert$ {\it
 int-expr} {\tt ]}...
\end{tabular}
...
\hspace{0.5cm} {\openb}{\it lower-bound}{\closeb} {\tt :} {\openb}{\it
  upper-bound}{\closeb} {\openb}{\tt :} {\it step}{\closeb}
...
in C}. An array section is built from a subset of the elements of an
array, which is specified by this notation including at least one {\it
triplet}.

When {\it step} is positive, the {\it triplet} specifies a set of
subscripts that is a regularly spaced sequence of integers beginning
with {\it lower-bound} and proceeding in increments of the {\it stride}
to the largest such integer not greater than the {\it upper-bound}.
%
When {\it step} is negative, the {\it triplet} specifies a set of
subscripts that is a regularly spaced sequence of integers beginning
with the {\it lower-bound} and proceeds in increments of the {\it step}
down to the smallest such integer equal to or greater than the {\it
upper-bound}.
...
\begin{itemize}
 \item \verb![C]! Each of {\it lower-bound}, {\it upper-bound} and {\it
       step} must be an {\it integer-expr}.
...
\begin{tabular}{lll}
\hspace{0.5cm} & {\tt A[10:19]} & array section of 10 elements from {\tt
 A[10]} to {\tt A[19]} \\
 & {\tt A[10:]} & array section of 90 elements from {\tt A[10]} to {\tt
	 A[99]} \\
 & {\tt A[:9]} & array section of 10 elements from {\tt A[0]} to {\tt
	 A[9]} \\
 & {\tt A[10:19:2]} & array section of 5 elements from {\tt A[10]} to
	 {\tt A[18]} by step 2 \\
