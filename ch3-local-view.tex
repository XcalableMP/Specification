...
The result of the descriptor-of operator (``{\tt xmp\_desc\_of}'')
applied to {\XMP} entities such as node arrays, templates and global
arrays is their {\it descriptor}, which can be used, for example, as an
