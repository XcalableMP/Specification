...
\begin{tabular}{ll}
\verb![C]! & {\it data-type} {\it variable} {\tt :} {\it codimensions} \\
\end{tabular}
...
{\it assumed-shape-spec-list} of the same rank as the associated global array.
...
\begin{itemize}
 ...
 \item An associating local array shall be declared with
       {\it assumed-shape-spec-list} of the
