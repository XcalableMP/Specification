...
\Term{descriptor-of operator}
\index{{\tt xmp\_desc\_of}}

\subsubsection*{Format}

\begin{tabular}{lll}

\verb![F]!&  {\tt xmp\_desc\_t}& {\tt xmp\_desc\_of(xmp\_entity)}\\
...
{\tt xmp\_desc\_of} returns the descriptor or is evaluated to the
pointer to the descriptor of a global array, a template, or a node
array. The resulting descriptor can be used as an input argument of some
inquiry procedures.

The type of the descriptor, {\tt xmp\_desc\_t}, is
implementation-dependent, and defined in the {\tt XMP} standard module in
{\XMPF} or the {\tt xmp.h} heder file in {\XMPC}.

\subsubsection*{Arguments}

The argument or operand {\tt xmp\_entity} is the name of either a golbal
