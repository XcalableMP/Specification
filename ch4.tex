...
If both of an acutual and its associating dummy arguments are coarrays,
...
If the actual argument is an array name or an array section,
...
each of which starts from the received address.
%
...
\begin{myfigure}
 ...
 \caption{Sequence Association of an Section of a Global Data as an
