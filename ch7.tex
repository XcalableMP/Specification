...
\subsection{\tt xmpc\_nodes\_index}
\index{xmpc\_nodes\_index@{\tt xmpc\_nodes\_index}}

\subsubsection*{Format}

\begin{tabular}{lll}

\verb![C]!&  {\tt int}& {\tt xmpc\_nodes\_index(xmp\_desc\_t d, int dim, int *index)}\\

\end{tabular}

\subsubsection*{Synopsis}

The {\tt xmpc\_nodes\_index} function provides the indices - 1 of the executing node in the target node array.
...
\begin{itemize}
 \item {\tt index} is an index - 1 of the target dimension of the node array
       specified by {\tt d}.
\end{itemize}
