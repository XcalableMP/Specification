...
\subsection{\tt xmp\_node\_rank}
\label{subsec:xmpnoderank}
\Intrinsic{xmp\_node\_rank}

\subsubsection*{Format}

\begin{tabular}{lll}

\verb![F]!&  {\tt integer function}& {\tt xmp\_node\_rank()}\\

\verb![C]!&  {\tt int}& {\tt xmp\_node\_rank(void)}

\end{tabular}

\subsubsection*{Synopsis}
The {\tt xmp\_node\_rank} routine returns the node number - 1,
within the current executing node set, of the node that calls {\tt xmp\_node\_rank}.
