...
(called {\it child tasks}) are executed in arbitrary order without 
...
constructs of child tasks are evaluated at the entry of the immediately
...
Note that array assignments can be used also in {\C}, which is one of
