...
\begin{tabular}{ll}
 ...
 {\openb}, {\it template-spec} {\closeb}... \verb|)| \\
 \hspace{0.5cm} \verb![C]!& {\it template-name} \verb|[| {\it template-spec} \verb|]|
...
If {\it int-expr} is specified as {\it template-spec},
the default lower bound is one in XcalableMP Fortran, and the default lower bound is zero in XcalableMP C.
...
... & ... \\ \hline
{\tt p[4][7]} & {\tt t[53:12][7:8:8][0:64]} \\ \hline
\end{tabular}
\end{center}
\end{minipage}
...
\item \verb![F]! \mytextcolor{red}{The array specified by {\it array-name} shall not be
	  initially defined.}
\item \verb![C]! \mytextcolor{red}{The array specified by {\it array-name} shall not be
