%#BIBTEX /Library/TeX/texbin/bibtex main
...
\input{ch-overview.tex}
%\input{glossary.tex}
\cleardoublepage

\input{ch-directive.tex}
\input{dir-acc.tex}
\input{dir-barrier.tex}
\input{dir-device.tex}
\input{dir-barrier-device.tex}
% \input{ch3-template.tex}
% \input{ch3-work.tex}
% \input{ch3-gcomm.tex}
% \input{ch3-tasklet.tex}
