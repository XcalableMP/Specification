...
or the interface body that immediately surrounds the directives unless
it is use or host associated.

The following directives are the declarative directives.
...
The following directives are the executable directives.
