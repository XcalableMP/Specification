...
\verb![F]!&\verb|!$xmp| {\tt nodes} {\it nodes-name} ( {\it nodes-size}
     [, {\it nodes-spec} ] ... ) {\tt = *}\\
\verb![F]!&\verb|!$xmp| {\tt nodes} {\it nodes-name} ( {\it nodes-size}
     [, {\it nodes-spec} ] ...) {\tt =} {\it nodes-ref}\\
& \\
\verb![C]!&\verb|#pragma xmp| {\tt nodes} {\it nodes-name} ( {\it
     nodes-spec} [, {\it nodes-spec} ] ... ) \\
\verb![C]!&\verb|#pragma xmp| {\tt nodes} {\it nodes-name} ( {\it
     nodes-size} [, {\it nodes-spec} ] ... ) {\tt = *} \\
\verb![C]!&\verb|#pragma xmp| {\tt nodes} {\it nodes-name} ( {\it
     nodes-size} [, {\it nodes-spec} ] ... ) {\tt =} {\it nodes-ref}\\
\end{tabular}
}
\vspace{0.3cm}
...
The node reference expression is used to reference a subset of a node
set.
...
\begin{center}
\begin{tabular}{lll}
{\it nodes-ref} & {\bf is} & ( {\it int-expr} )\\
                & {\bf or} & ( {\it triplet} ) \\
                & {\bf or} & {\it nodes-name} [ ( {\it nodes-subscript}
	 [, {\it nodes-subscript} ]... ) ] \\
\end{tabular}
\end{center}
...
The ``{\tt *}'' symbol apperared as {\it nodes-subscript} in a dimension
of {\it nodes-ref} is interpreted as the position (coordinate) of each
node in the dimension of the referenced node array.
...
Note that ``{\tt *}'' can be used only in the node reference appeared in
