...
\verb![F]! & {\openb} \verb|!$xmp coarray| {\it variable-name}
     {\openb}{\tt ,} {\it variable-name} {\closeb}{\tt ...} {\tt on}
     {\it nodes-ref} {\closeb}\\
...
For {\XMPF}, coarrays are declared in the same manner
as in Fortran 2008. For {\XMPC}, coarrays are declared with
...
specifies a node array on each element of which 
...
then it is assumed that a node array corresponding to the executing node
set is specified.
