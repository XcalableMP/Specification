 ...
 XcalableMP has three kinds of I/O.
  ...
  Dynamic connection of global I/O is global (collective) execution and
...
%  \Syntax{tasks}
  ...
  \end{tabular}
   ...
   \begin{itemize}
   \item The following items including a global array or subobject of a global array must not appear in an input item or output item.
	  \begin{itemize}
...
%   Global I/O is restricted within unformatted (binary) files, but higher performance and lower memory consumption can be expected than master I/O.
   ...
   \subsection{file\_sync\_all directive}
   ...
   When two accesses to the same file conflict in atomic or direct I/O,
   ...
   the nodes connected the specified file-unit-number, and then causes
   ...
   The statement is a collective execution.
...
%    \caption{aaa}
   ...
   \begin{table}[h]
    ...
    \begin{tabular}{|c|p{120mm}|}
	 ...
	 will be overwritten. File pointer points the beginning of th file. \\ \hline
   ...
   \begin{table}[h]
    \begin{center}
     \begin{tabular}{|l|r|p{80mm}|}
      ...
      argument & xmp\_file\_t $*$fh & file structure \\ \cline{2-3}
      & void $*$buffer & beginning address of loading variables \\ \cline{2-3}
   ...
   \begin{table}[h]
    \begin{center}
     \begin{tabular}{|l|r|p{80mm}|}
      ...
      argument & xmp\_file\_t $*$fh & file structure \\ \cline{2-3}
      & void $*$buffer & beginning address of storing variables \\ \cline{2-3}
...
%    \caption{aaa}
   ...
   Direct I/O is executed in local and using the individual pointer. 
